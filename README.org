...
5. If user load liberime failure, please check and make sure
   ...
   2. Method 2: copy librime.dll to one of the directories.
      1. the directory of emacs.exe
      2. /usr/local/bin
      3. /usr/bin
6. When liberime-core.dll is loaded, rebuild it will not be
   successful, for librime.dll has been opened.
